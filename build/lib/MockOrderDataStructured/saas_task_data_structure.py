...
class SaasTaskDataStructure:
    ...
    def generate_documentation(self,output_directory):
        ...
        with open("{0}/SaasTaskDataStructure_Documentation.txt".format(output_directory), "w") as file:
            for field in fields:
        ...
        with open("{0}/SaasTaskDataStructure_Documentation.json".format(output_directory), "w") as json_file:

...
class SaasPartnerOrderDataStructure:
    ...
    def generate_documentation(self,output_directory):
        ...
        with open("{0}/SaasPartnerOrderDataStructure_Documentation.txt".format(output_directory), "w") as file:
            for field in fields:
        ...
        with open("{0}/SSaasPartnerOrderDataStructure_Documentation.json".format(output_directory), "w") as json_file:
